...
var srcDir = projectDir.cwd('./ng2-group-multiselect');
...
var copyTask = function () {
    return projectDir.copyAsync('ng2-group-multiselect', destDir.path(), {
            overwrite: true,
...
var lessTask = function () {
    return gulp.src('ng2-group-multiselect/stylesheets/main.less')
        .pipe(plumber())
        .pipe(less())
